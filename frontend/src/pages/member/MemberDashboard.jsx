...
export default function MemberDashboard() {
  ...
  return (
    <div>
      <h2 style={{ marginTop: 0, color: '#1a3c5e' }}>My Dashboard — {data.current_year}</h2>
      ...
      <div style={{ background: '#fff', padding: 20, borderRadius: 8, boxShadow: '0 2px 8px rgba(0,0,0,0.08)', maxWidth: 500 }}>
